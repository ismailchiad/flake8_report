...
class View:
    ...
    def is_valid_alpha(self, input_string):
        """
        Vérifie si chaîne caractères fournie contient uniquement caractères alphabétiques (+ des espaces).
    ...
    def get_valid_date_input(self, prompt):
        """
        Demande à utilisateur entrer date au format JJ/MM/AAAA jusqu'à ce qu'une entrée valide soit fournie.
    ...
    def get_valid_alpha_input(self, prompt):
        """
        Demande à utilisateur entrer une chaîne alphabétique jusqu'à ce qu'une entrée valide soit fournie.
    ...
    def get_valid_int_input(self, prompt, default_value=None):
        ...
        Si utilisateur n'entre rien et qu'une valeur par défaut est fournie, renvoie valeur par défaut.
