...
class Report:
    ...
    def load_players(self):
        """
        Charge liste joueurs depuis fichier players.json en cas d'erreur (fichier introuvable ou erreur
    ...
    def load_tournaments(self):
        """
        Charge liste tournois depuis fichier tournaments.json en cas d'erreur (fichier introuvable ou erreur
        de décodage JSON), un message d'erreur est affiché.
