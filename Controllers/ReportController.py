...
class ReportController:
    ...
    def tournament_players_alphabetical(self):
        """
        Charge liste des joueurs pour tournoi spécifique, triée par ordre alphabétique nom puis prénom.
    ...
    def get_tournament_players_sorted(self, tournament_id):
        """
        Charge et retourne liste joueurs pour tournoi spécifié, triée leur score en ordre décroissant.
